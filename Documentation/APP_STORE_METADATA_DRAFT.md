...
- 앱 이름: NudgeMate
- 부제: 반복 일정과 중요한 준비를 미리
- 짧은 소개: 캘린더의 일정 리듬을 기기에서 분석하고 다음 시점과 준비 체크인을 알려드립니다.
- 키워드: 일정,캘린더,리마인더,준비,루틴,반복,생산성,알림
...
- Name: NudgeMate
- Subtitle: Stay Ahead of Routines and Prep
- Short description: Discover scheduling rhythms on device and get timely nudges and adaptive preparation check-ins.
- Keywords: schedule,calendar,reminder,prep,routine,recurring,productivity,nudge
